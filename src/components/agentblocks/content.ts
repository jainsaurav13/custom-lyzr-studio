...
/* The catalogue itself, and the geometry it settles into, live in
 * `blocks.ts`: it is data and layout maths rather than page copy. */

/**
 * The two states the catalogue exists to contrast, put either side of a divider
 * the reader drags: the same thirty-three blocks, a scattered parts list on one
 * side, one platform on the other.
 */
