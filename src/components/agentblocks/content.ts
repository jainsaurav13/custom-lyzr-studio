...
export interface Block {
  ...
  num: string;
  name: string;
  /** The line the block itself carries: a few words, not a sentence. */
  tagline: string;
...
export const BLOCKS: Block[] = [
  {
    ...
    tagline: "Your customers’ front door",
    icon: "Store",
    color: "#C0503C",
  },
  {
    ...
    num: "02",
    name: "Agent Builder",
    tagline: "Design and ship agents",
    icon: "Wrench",
    color: "#B76D2B",
  },
  {
    ...
    tagline: "Every agent on the record",
    icon: "ShieldCheck",
    color: "#4F6F63",
  },
  {
    ...
    tagline: "The gate before launch",
    icon: "Gauge",
    color: "#737A80",
  },
  {
  ...
  },
  {
    ...
    num: "09",
    name: "Permissions",
    tagline: "Scoped to the last tool",
    icon: "Lock",
    color: "#9A6EA8",
  },
  {
  ...
  },
  {
    ...
    tagline: "Policy at the boundary",
    icon: "ShieldAlert",
    color: "#A7743B",
  },
  {
    ...
    tagline: "Enterprise load, absorbed",
    icon: "Boxes",
    color: "#7C7268",
  },
];
